...
function gameInit()
{
    ...
    for(var i = 0; i < column_width; i++){
        $star[0][i].animate({marginTop:'1100px'},2000);
    }
	operaflag = true;
}
...
function restartGame()
{
    ...
    $("#show").text("第" + level + "关").fadeIn().animate({left:'420px'},300);
    $("#showTarget").text("目标分数:" + goalScore).fadeIn().animate({left:'320px'},1000);
...
function nextlevel(){
    if(score < goalScore){
        ...
        $("#show").css("left","870px");
        $("#showTarget").css("left","1400px");
        $("#show").text("第" + level + "关").fadeIn().animate({left:'420px'},300);
        $("#showTarget").text("目标分数:" + goalScore).fadeIn().animate({left:'320px'},1000);

        document.getElementById("passed").className = "passlevel";
        passflag = true;
        $("#passed").css("top","380px");
        $("#passed").css("left","260px");
        $("#passed").css("width","530px");
        $("#passed").css("height","316px");
